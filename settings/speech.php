...
<div class="flex w-screen h-screen p-<?=$margin?> flex-col gap-<?=$margin?>">     
    ...
    <div class="grid grid-flow-col grid-cols-4 grid-rows-3 gap-<?=$margin?> h-full">
        <div onclick="" class="rounded-md bg-purple-400 col-span-4">
            <input id="minmax-range" type="range" min="0" max="30" value="5" class="w-full h-2 bg-purple-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700 p-<?=$margin?>">
