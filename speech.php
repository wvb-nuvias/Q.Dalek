...
<div class="flex w-screen h-screen p-<?=$margin?> flex-col gap-<?=$margin?>">     
    ...
    <div class="grid grid-flow-col grid-cols-4 grid-rows-6 gap-<?=$margin?> h-full">
        ...
        <button onclick="speak('I am your soldier')" class="rounded-md bg-green-200 col-span-3">
            <div class="flex flex-col gap-<?=$itemmargin?>">
        ...
        <button onclick="previous()" class="rounded-md bg-green-400 row-span-2">
            <div class="flex flex-col gap-<?=$itemmargin?>">
                <div class="h-4/5 <?=$iconsize?> fa-solid fa-chevron-left"></div>
                <div class="h-1/5 <?=$textsize?>">Previous</div>
            </div>
        </button>
        <button onclick="next()" class="rounded-md bg-purple-400 row-span-2">
            <div class="flex flex-col gap-<?=$itemmargin?>">
                <div class="h-4/5 <?=$iconsize?> fa-solid fa-chevron-right"></div>
                <div class="h-1/5 <?=$textsize?>">Next</div>
            </div>
        </button>
        <button onclick="back()" class="rounded-md bg-pink-400 row-span-2">
            <div class="flex flex-col gap-<?=$itemmargin?>">
